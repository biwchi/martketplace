...
export const productDescription = {
  ...
  update: 'Update details or attributes of an existing product owned by the authenticated seller.',
  delete: 'Delete an existing product owned by the authenticated seller.',

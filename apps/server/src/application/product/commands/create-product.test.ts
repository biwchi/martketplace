...
import { CreateProduct, type CreateProductError } from "./create-product";
import {
  createCreateProductInput,
  createMockRepositories,
  FixtureIds,
} from "./create-product.fixtures";
import { createProductAttributeInput } from "../product-attributes.validator.fixtures";
import { AttributeId, SelectOptions } from "../product-attributes.validator.fixtures";
...
describe("CreateProduct", () => {
  ...
  describe("when product attributes are invalid", () => {
    it("returns err with reason invalid-product-attributes and validation details", async () => {
      const { command, productRepository, categoryAttributeRepository } =
        createCommand();
      const input = createCreateProductInput({
        product: {
          attributes: [

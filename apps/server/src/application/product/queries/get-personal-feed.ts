...
import type { Product, ProductMetric, ProductMetricRepository, ProductRepository } from '@domain/product'
...
import { PRODUCT_METRIC_REPOSITORY_TOKEN, PRODUCT_REPOSITORY_TOKEN } from '@domain/product'
...
interface ProductWithMetric { product: Product, metric?: ProductMetric }
...
function getCandidatesCacheKey(visitor: Visitor) {
